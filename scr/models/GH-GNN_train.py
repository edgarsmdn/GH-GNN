...
def train_GNNGH_T_kfold(df, model_name, hyperparameters):
...
def train_GNNGH_T(df, model_name, hyperparameters):
...
train_GNNGH_T(df, 'GNNGH_T_epochs_'+str(args.epochs), hyperparameters_dict)
# train_GNNGH_T_kfold(df, 'GNNGH_T_epochs_'+str(args.epochs), hyperparameters_dict)