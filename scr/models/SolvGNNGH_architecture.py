'''
Project: GNN_IAC_T
                    SolvGNN Gibbs-Helmholtz architecture
...
class SolvGNNGH(nn.Module):
    def __init__(self, in_dim, hidden_dim, n_classes=1):
        super(SolvGNNGH, self).__init__()
        ...
        # MLP for C
        self.mlp1c = nn.Linear(hidden_dim*2, hidden_dim)
        self.mlp2c = nn.Linear(hidden_dim, hidden_dim)
        self.mlp3c = nn.Linear(hidden_dim, n_classes)
